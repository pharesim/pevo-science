...
import metadataRouter from './accreditation-metadata.js';
...
// Self-service metadata-edit routes (PATCH /metadata) live in their own module —
// they share none of this file's OTP / email-verify / token-cleanup machinery.
// Composed here so they stay under the same /api/accreditation prefix.

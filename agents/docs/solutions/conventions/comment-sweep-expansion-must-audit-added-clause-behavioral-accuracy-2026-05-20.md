...
- [[universal-mock-inventory-must-be-re-derived-not-incrementally-patched-2026-06-11]] — the set-membership complement: this convention audits the clauses ADDED beyond the prescription; that one requires the SURVIVING universal claim (an only/all/every stated set) to be re-derived from ground truth rather than extended by splicing in the named element. Together they cover added text and surviving text of an edited comment.

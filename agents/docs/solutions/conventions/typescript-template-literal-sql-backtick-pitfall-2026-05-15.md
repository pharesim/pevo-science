...
- [migrations-sole-schema-authority-2026-05-25.md](migrations-sole-schema-authority-2026-05-25.md) — backend-zone schema convention (migrations are the sole schema authority; no startup DDL). Readers navigating SQL-in-backend pitfalls benefit from this doc too.

...
| [auth.md](api-contracts/auth.md) | `/api/auth/*` — session, signup, login, password reset, recovery, ORCID auth |
...
| [profiles.md](api-contracts/profiles.md) | `/api/profile/*`, `/api/settings/email/*`, `/api/accounts/search` — profiles, notification prefs, email settings |
| [accreditation.md](api-contracts/accreditation.md) | `/api/accreditations/*`, `/api/accreditation/*`, `/api/wot/*` — accreditation, ORCID accreditation, web of trust |
